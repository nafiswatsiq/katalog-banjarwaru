                ...
                <div class="space-y-4">
                    ...
                    <div class="relative">
                        <div class="swiper product-gallery-main rounded-xl overflow-hidden shadow-lg">
                            ...
                            <!-- Zoom icon -->
                            <button class="absolute flex items-center top-4 right-4 bg-white bg-opacity-80 text-gray-700 p-2 rounded-full hover:bg-opacity-100 transition duration-300 z-10">
    ...
    <section class="py-12 bg-gray-50">
        <div class="container mx-auto lg:px-10 px-4">
            <div class="flex gap-4">
                <div class="w-24 h-20 rounded-full overflow-hidden">
                    <img src="https://img.lovepik.com/free-png/20210919/lovepik-green-bamboo-elements-png-image_400659752_wh1200.png" alt="Product Tabs Icon" class="w-full h-full object-cover">
                </div>
                <div>
                    <h2 class="text-xl font-semibold text-gray-800">Toko Bu Lastri</h2>
                    <p class="text-gray-600">Pengrajin kerajinan bambu berkualitas tinggi</p>
                    <p class="mt-2 text-gray-600">WhatsApp: 0812-3456-7890</p>
                    <p class=" text-gray-600">Alamat: Jl. Raya Bambu No. 123, Jakarta</p>
                </div>
            </div>
            {{-- <div
                x-data="{
                ...
                <div x-ref="tabButtons" class="relative inline-grid items-center justify-center w-full h-10 grid-cols-4 p-1 text-gray-500 bg-white border border-gray-100 rounded-lg select-none">
                    <button :id="$id(tabId)" @click="tabButtonClicked($el);" type="button" :class="{ 'bg-green-800 text-white text-lg' : tabButtonActive($el) }" class="relative z-20 inline-flex items-center justify-center w-full h-8 px-3 text-sm font-medium transition-all rounded-md cursor-pointer whitespace-nowrap">Deskripsi Detail</button>
                    <button :id="$id(tabId)" @click="tabButtonClicked($el);" type="button" :class="{ 'bg-green-800 text-white text-lg' : tabButtonActive($el) }" class="relative z-20 inline-flex items-center justify-center w-full h-8 px-3 text-sm font-medium transition-all rounded-md cursor-pointer whitespace-nowrap">Spesifikasi</button>
                ...
                <div class="relative flex items-center justify-center w-full p-5 mt-2 text-gray-400 border rounded-md content border-gray-200/70">
